...
export function EditPlantSheet({ plant, open, onOpenChange, onSuccess }: EditPlantSheetProps) {
  ...
  async function onSubmit(values: PlantFormValues) {
    try {
      ...
      if (!res.ok) {
        throw new Error("Fehler beim Aktualisieren der Pflanze")
      }
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Pflanze bearbeiten</SheetTitle>
          <SheetDescription>
